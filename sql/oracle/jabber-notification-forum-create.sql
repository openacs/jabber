...
-- more then one implementation of it's interface (like it schould by openacs definition) 
-- but the service contract package dosn't seem to be able to properly populate multiple implementations 
-- of the same interface (service contract). Even if it alowes multiple implementations to exist           
