...
function openjabberwin(redirect) {
  para = "alwaysRaised=1,height=220,width=200,screenX=400,screenY=400,titlebar=0,status=0" 
  window.open("jabber-auto-login.tcl" , "jabber" , para);
...
<p>If no new small window has opened please click <a href='jabber-webstart-auto-login.tcl' target='Jabber'>this Link</A> to open a new window for the Jabber client,
